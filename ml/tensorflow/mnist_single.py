...
flags.DEFINE_string(
	...
	help="The location of the model dir.")
flags.DEFINE_integer(
	name="steps", short_name="te", default=100,
	help="steps of the train")
flags.DEFINE_float(
	name="learning_rate", short_name="lr", default=0.005,
	help="learning rate of the train")
flags.DEFINE_integer(
	name="batch_size", short_name="bs", default=100,
